...
import { X, Calendar, CreditCard as CreditCardIcon } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="1234"
                maxLength={4}
                className="w-full px-4 py-3 bg-background border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-foreground font-mono"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 text-muted-foreground">$</span>
                  <input
                    type="number"
                    value={balance}
                    ...
                    placeholder="0.00"
                    step="0.01"
                    className="w-full pl-8 pr-4 py-3 bg-background border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-foreground font-mono"
                    required
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-background border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-foreground"
                required
              />
            </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      color === colorOption.value
                        ? 'border-ring-offset-2 ring-2 ring-primary'
                        : 'border-border hover:border-muted'
                    )}
                    style={{ backgroundColor: color === colorOption.value ? colorOption.value : 'transparent' }}
                    title={colorOption.name}
                  >
                    <div
                      className="w-4 h-4 rounded-full transition-transform hover:scale-110"
                      style={{ backgroundColor: color === colorOption.value ? 'white' : 'transparent' }}
                    />
                  </div>
                ))}
              </div>
