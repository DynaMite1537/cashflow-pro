...
import { Wallet, LineChart, Calendar, Settings, LogOut, CreditCard, List } from 'lucide-react';
...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { id: 'transactions', label: 'Transactions', icon: List, href: '/transactions' },
  ...
  return (
    <div className="flex h-screen bg-background text-foreground font-sans">
      ...
      <main className="flex-1 overflow-auto bg-background relative">
        <MobileBottomNav />
        <div className="max-w-7xl mx-auto p-8 space-y-8">{children}</div>
      </main>
